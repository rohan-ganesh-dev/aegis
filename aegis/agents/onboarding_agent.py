    ...
    def __init__(self, agent_id: str = "onboarding_agent"):
        ...
        super().__init__(
            ...
            system_instruction=(
                ...
                "- API Key Status: [VALID/INVALID with key preview]\n"
                "- Authentication Test: [SUCCESS/FAILED with details]\n"
                "- List findings as clear bullets\n"
                "\n"
                "**Actions Taken:**\n"
                "- Executed diagnose_401_error() → Found root cause: INVALID_KEY_OR_HEADERS\n"
                "- Executed verify_api_key() → Confirmed key sk_test_xyz... is VALID\n"
                "- Executed test_api_authentication() → Test call returned 200 OK (247ms)\n"
                "- Executed apply_fix_for_401() → Generated correct authentication example\n"
                "- List ACTUAL tool executions with results as bullets\n"
                "\n"
                "**Next Steps:**\n"
                ...
                "\n"
                "❌ BAD: 'Section 1 - Diagnostic Results: I'll check your account'\n"
                "✅ GOOD: 'Diagnostic Results:\n- Root cause: Invalid headers\n- API key: VALID (sk_test_xyz...)'\n"
                "\n"
                "NEVER skip any section. ALWAYS use bullets under each heading.\n"
                "\n"
